...
export const GridItem = ({
  ...
  const gridItemStyles = cva(
    "overflow-hidden hover:cursor-pointer w-full h-full will-change-transform",
    {
      variants: {
        variant: {
          default: "rounded-2xl border border-white/10 shadow-2xl",
          masonry: "even:mt-[50%] rounded-2xl border border-white/10 shadow-2xl",
          polaroid:
            "border-8 border-b-24 border-white/90 shadow-2xl even:rotate-3 odd:-rotate-2 hover:rotate-0 transition-transform ease-out duration-300 even:mt-[50%]",
        },
      },
      defaultVariants: {
        variant: "default",
...
export const GridBody = memo(
  ({
    ...
    const gridBodyStyles = cva("grid grid-cols-[repeat(6,1fr)] h-fit w-fit", {
      variants: {
        variant: {
          default: "gap-8 p-4 md:gap-14 md:p-8",
          masonry: "gap-x-8 px-4 md:gap-x-14 md:px-8",
          polaroid: "gap-x-8 px-4 md:gap-x-14 md:px-8",
        },
      },
      defaultVariants: {
        variant: "default",
