...
export default function Services() {
  return (
    <section
      id="services"
      className="relative w-full bg-[#050505] text-white pt-16 sm:pt-24 md:pt-28 pb-24 sm:pb-32 md:pb-40 overflow-hidden border-t border-white/5 z-20 select-none flex flex-col items-center justify-center"
    >
